...
class ActivityDetailJinxingzhongPage extends StatefulWidget {
  Map<String, dynamic> userInfoDic;
  ActivityDetailJinxingzhongPage({super.key, required this.userInfoDic});
  @override
...
class MyActivityListPageState extends State<ActivityDetailJinxingzhongPage> {
  List dataSource = [];
  int _pageNo = 1;
        ...
        child: Stack(
          // color: const Color(0xFFFAFAFA),
            children:[
              ...
              widget.userInfoDic['activeSource'].toString()=='0'?
                    ...
                    children: [
                      Positioned(
                          child: SizedBox(
                              ...
                              height: 45.1,
                              child: ClipOval(
                                child: Image(image: NetworkImage(widget.userInfoDic['activityAvatar']![index]['avatar'])
                                  ,width: 45.1,height: 45.1,fit: BoxFit.cover,),
                              )
                          )),
                      ...
                      Positioned(
                        ...
                        right: 0,
                        top: 0,
                        child: Image(image: widget.userInfoDic['activityAvatar']![index]['sex'].toString()=='1'
                            ?const AssetImage('images/activity_man.png')
                            :const AssetImage('images/activity_woman.png'),),
                      ),
                      // Positioned(
                      //     bottom: 2,
