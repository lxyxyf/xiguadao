...
class ActivityDetailFullBaomingPage extends StatefulWidget {
  Map<String, dynamic> userInfoDic;
  ActivityDetailFullBaomingPage({super.key, required this.userInfoDic});
  @override
...
class MyActivityListPageState extends State<ActivityDetailFullBaomingPage> {
  List dataSource = [];
  final int _pageNo = 1;
        ...
        child: Stack(
          // color: const Color(0xFFFAFAFA),
            children:[
              ...
              widget.userInfoDic['isEnroll'] ==true&&widget.userInfoDic['isInitiator']==true?
              Positioned(
                  left: 0,
                  right: 0,
                  bottom: 0,
                  ...
                  )):widget.userInfoDic['isEnroll'] ==true&&widget.userInfoDic['isInitiator']==false?
              Positioned(
                  left: 0,
                  right: 0,
                  bottom: 0,
