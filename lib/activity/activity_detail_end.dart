...
class ActivityDetailEndgPage extends StatefulWidget {
  Map<String, dynamic> userInfoDic;
  ActivityDetailEndgPage({super.key, required this.userInfoDic});
  @override
...
class MyActivityListPageState extends State<ActivityDetailEndgPage> {
  List dataSource = [];
  int _pageNo = 1;
          ...
          child:  Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Container(
                  //   padding: const EdgeInsets.only(top: 4.5,left: 7,right: 7,bottom: 4.5),
                  //   decoration: BoxDecoration(
