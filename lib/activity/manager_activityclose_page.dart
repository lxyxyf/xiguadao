...
class ManagerActivityClosePage extends StatefulWidget {
  Map<String, dynamic> userInfoDic;
  ManagerActivityClosePage({super.key, required this.userInfoDic});
  @override
...
class MyActivityListPageState extends State<ManagerActivityClosePage> {
  List dataSource = [];
  int _pageNo = 1;
                  ...
                  Container(
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: const Text('再次发起',textAlign: TextAlign.center,style: TextStyle(
