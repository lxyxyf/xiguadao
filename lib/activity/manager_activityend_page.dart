...
class ManagerActivityEndPage extends StatefulWidget {
  Map<String, dynamic> userInfoDic;
  ManagerActivityEndPage({super.key, required this.userInfoDic});
  @override
...
class MyActivityListPageState extends State<ManagerActivityEndPage> {
  List dataSource = [];
  int _pageNo = 1;
