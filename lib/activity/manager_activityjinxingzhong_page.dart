...
class ManagerActivityjinxingzhongPage extends StatefulWidget {
  Map<String, dynamic> userInfoDic;
  ManagerActivityjinxingzhongPage({super.key, required this.userInfoDic});
  @override
...
class MyActivityListPageState extends State<ManagerActivityjinxingzhongPage> {
  List dataSource = [];
  int _pageNo = 1;
  String userIdStr = '';
  List typeList = [];
    ...
    return GestureDetector(
        onTap: () {
          if (widget.userInfoDic['isInitiator']==true&&widget.userInfoDic['isEnroll']==true&&widget.userInfoDic['activityAvatar']![index]['userId'].toString()!=userIdStr){
            ...
            userdic['nickname'] = widget.userInfoDic['activityAvatar']![index]['name'];
