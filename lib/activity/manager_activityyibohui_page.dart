...
import 'package:xinxiangqin/activity/update_activity_page.dart';

import '../widgets/network_image_widget.dart';



class ManagerActivityYibohuiPage extends StatefulWidget {
  Map<String, dynamic> userInfoDic;
  ManagerActivityYibohuiPage({super.key, required this.userInfoDic});
  @override
...
class MyActivityListPageState extends State<ManagerActivityYibohuiPage> {
  List dataSource = [];
  int _pageNo = 1;
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: const Text('驳回原因',style: TextStyle(
                              ...
                              Container(
                                ...
                                child: Container(
                                  child: Text(widget.userInfoDic['rejectReason'] ?? '没有原因',style: const TextStyle(
                ...
                Container(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: const Text('修改活动',textAlign: TextAlign.center,style: TextStyle(
                          color:Colors.white,
                          fontSize: 14,
                          fontWeight: FontWeight.w500
                      ),),
                  ...
                  Stack(
                    ...
                    children: [
                      ...
                      Positioned(
                          bottom: 2,
                          child:  Text(
                            widget.userInfoDic['activityAvatar']![index]['isInitiator']==true?'发起人':'',
