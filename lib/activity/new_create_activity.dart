...
class NewCreateActivity extends StatefulWidget {
  const NewCreateActivity({super.key});

  @override
  _MyStatefulWidgetState createState() => _MyStatefulWidgetState();
}

class _MyStatefulWidgetState extends State<NewCreateActivity> {
  ...
  createActivitySubmit() async {
    ...
    map['activeSource'] = '0';
    map['activityAvatar'] = userInfoDic['avatar'];
