...
class NewactivityDetailPage extends StatefulWidget {
  Map<String, dynamic> userInfoDic;
  NewactivityDetailPage({super.key, required this.userInfoDic});
  @override
...
class MyActivityListPageState extends State<NewactivityDetailPage> {
  List dataSource = [];
  int _pageNo = 1;
    ...
    return Scaffold(
      ...
      body: Stack(
          ...
          children:[
                          ...
                          children: [
                            Positioned(
                                ...
                                Container(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image(
                                        image: NetworkImage(
                                            widget.userInfoDic['activityAvatar']![0]['avatar']),width: 45.1,height: 45.1,fit: BoxFit.cover,
                                      ),
                                    )
                                )
                            ),
                            ...
                            Positioned(
                                ...
                                Container(
                                  ...
                                  // ),
                                  child: Image(image:
                                  widget.userInfoDic['activityAvatar']![0]['sex'].toString()=='1'?const AssetImage('images/activity_man.png')
                                ...
                                Column(
                                  children: [
                                    Container(
                                        ...
                                        child: Text(widget.userInfoDic['activityAvatar']![0]['name'],
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                  height: widget.userInfoDic['isEnroll'] ==true&&widget.userInfoDic['activityAvatar'].length>1?85:55,
                                  ...
                                  child: Container(
                                    child: Column(
                                      children: [
                                        ...
                                        //   children: [
                                        //     Container(
                                        //       margin: const EdgeInsets.only(left: 15.5,top: 15.5),
                                        //       child: const Image(image: AssetImage('images/activity_name_icon.png'),width: 13.5,height: 13.5,),
                                        //     ),
                                        //     Container(
                                        ...
                                        //       child: Text(widget.userInfoDic['name']!=null||widget.userInfoDic['name']!=''?widget.userInfoDic['name']:'',style: const TextStyle(
                              ...
                              Container(
                                ...
                                padding: const EdgeInsets.only(bottom: 17,left: 15,right: 15,top: 15),
                                child: Container(
            ...
            widget.userInfoDic['isInitiator']==true?Positioned(
                left: 25,
                right: 25,
                bottom: 32,
                child:
                GestureDetector(
                  onTap: (){
                    widget.userInfoDic['isInitiator']==true?managerActivity():chatClick();
                  },
                  child: Container(
                    alignment: Alignment.center,
                    height: 45,
                    ...
                    child: Text(widget.userInfoDic['isInitiator']==true?'管理活动':'与发起人聊天',textAlign: TextAlign.center,style: const TextStyle(
                        color:Colors.white,
                        fontSize: 14,
                        fontWeight: FontWeight.w500
                    ),),
  ...
  Widget _buildTypeItem(BuildContext context, int index) {
    return GestureDetector(
        onTap: () {
          if (widget.userInfoDic['isEnroll']==true&&widget.userInfoDic['activityAvatar']![index]['userId'].toString()!=userIdStr){
            typeSeletRow = index;
          ...
          child:  Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  widget.userInfoDic['isEnroll']==true&&widget.userInfoDic['activityAvatar']![index]['userId'].toString()!=userIdStr
                      ?Container(
