...
class Closeqingshaonianmoshi extends StatefulWidget {
  final bool? havePhoneNumber;
  final String? photoNumber;
  String codeStr;
  Closeqingshaonianmoshi(
...
class ChangePasswordPageState extends State<Closeqingshaonianmoshi> {
          ...
          child: Container(
            child: Column(
              children: [
                ...
                //   },
                //   child: Container(
                //     child: Text('忘记了？',style: TextStyle(
                //       color: Color(0xffFE7A24),
                //       fontSize: 14,
                //       fontWeight: FontWeight.w500,
                //       decoration: TextDecoration.underline,
                //       decorationColor: Color(0xffFE7A24),
                //     ),),
                //   ),
                // ),
  ...
  void codeYanZheng() async {
    ...
    //   return;
    // }
    log('输入的密码'+codeController1.text+codeController2.text+codeController3.text+
    ...
    if (password==codeController1.text+codeController2.text+codeController3.text+
      ...
      await sharedPreferences.setString('qingshaonianmoshi', 'false');
