...
import 'package:xinxiangqin/home/surepassword.dart';
...
class ChangePasswordPageState extends State<Setpassword> {
  ...
  void codeYanZheng() async {
    ...
    await share.setString('qingshaonianPassword', codeController1.text+codeController2.text+codeController3.text+
        codeController4.text);

    Navigator.push(context,
        MaterialPageRoute(builder: (BuildContext ccontext) {
          return Surepassword(
            codeStr: codeController1.text+codeController2.text+codeController3.text+
                codeController4.text,
          );
        }));
    return;
