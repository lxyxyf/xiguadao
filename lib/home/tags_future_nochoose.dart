...
class TagsFutureNochoose extends StatefulWidget {
  ...
  const TagsFutureNochoose(
      {Key? key, required this.tagList, this.onSelect, this.isSingle = false})
      : super(key: key);

  @override
  State<TagsFutureNochoose> createState() => _SelectTagState();
}

class _SelectTagState extends State<TagsFutureNochoose> {
