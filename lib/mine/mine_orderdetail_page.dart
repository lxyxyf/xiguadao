...
class MineOrderdetailPage extends StatefulWidget {
  String orderId;
  MineOrderdetailPage({ required this.orderId});
...
class MinePageState extends State<MineOrderdetailPage> {
  ...
  sureDelete()async{
    EasyLoading.show();
    NetWorkService service = await NetWorkService().init();
    service.delete(Apis.deleteBlindTradeOrder, queryParameters: {'id':widget.orderId}, successCallback: (data) async {
      EasyLoading.dismiss();
      log('删除订单data'+data.toString());
      if (data==true){
        Navigator.pop(context);
      }
    }, failedCallback: (data) {
                      ...
                      children: [
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: 4.5,),
                                        Text(orderDic['orderType']==1?'有效期：'+orderDic['openContent']:'服务时间：'+orderDic['openNum'].toString()+'个月',style:
                        ...
                        Row(
                          ...
                          children: [
                            Text('商品总额：',style:
                            TextStyle(color: Color(0xff666666),fontSize: 14,fontWeight: FontWeight.w500),),
                            Text(orderDic['payPrice']!=null?'¥'+orderDic['payPrice'].toString():'¥0',style:
