...
class MineWantknowotherListpage extends StatefulWidget {
  const MineWantknowotherListpage({super.key});
...
class MyActivityListPageState extends State<MineWantknowotherListpage> {
    ...
    return MaterialApp(
      home: Scaffold(  backgroundColor: Color(0xfffafafa),
          appBar: AppBar(
            ...
            title: const Text("我想认识",textAlign: TextAlign.left,style: TextStyle(color: Color(0xff333333),fontSize: 16,fontWeight: FontWeight.bold),),
            leading: IconButton(
...
//         BoxDecoration(border: Border.all(color: Colors.black26, width: 1)),
  ...
  godetail(infodic){
    log('我想认识别人跳转传值'+infodic['id'].toString());
  ...
  void getList() async {
    ...
    service.get(Apis.getSendLikeList, queryParameters: {
