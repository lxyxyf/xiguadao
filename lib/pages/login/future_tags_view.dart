...
class FutureTagsView extends StatefulWidget {
  ...
  const FutureTagsView(
      {Key? key, required this.tagList, this.onSelect, this.isSingle = false})
      : super(key: key);

  @override
  State<FutureTagsView> createState() => _SelectTagState();
}

class _SelectTagState extends State<FutureTagsView> {
  ...
  pickPoint(item, index) {
    ...
    double textWidth = calculateTextWidth(
        item['labelName'],
        TextStyle(
          fontWeight: item['status']==0 ? FontWeight.w500 : FontWeight.normal,
          color: item['status']==0 ? const Color(0xFFFE7A24) : const Color(0xFF333333),
          fontSize: 14,
        ));
    //计算屏幕宽度
                ...
                InkWell(
                    ...
                    child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color: item['status']==0?const Color(0xFFFE7A24):Colors.white, // 边框颜色
                            width: item['status']==0?1.0:0.0, // 边框宽度
                          ),
                          color: Colors.white,
                        ),
