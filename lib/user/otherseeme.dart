...
class Otherseeme extends StatefulWidget {
  final String userId;
  final String likeFlag;//likeFlag 0 没有任何互动 1 我喜欢他  2 他喜欢我 3 互相喜欢
  final String recordId;
  const Otherseeme({super.key, required this.userId,required this.likeFlag,required this.recordId});
...
class _SecondPageState extends State<Otherseeme> {
...
//星座图片列表
    ...
    return Container(
      ...
      child:Stack(
        children: [
                                  ...
                                  Stack(
                                    children: [
                                      ...
                                      Positioned(
                                          ...
                                          top: 10,
                                          child:
                                      positionShouquan==true?Container(
          ...
          lickclick==0?Positioned(
              right: 0,
              top: screenSize.height/2,
              child: Container(
                child: Column(
                  children: [
                    widget.likeFlag=='0'||widget.likeFlag=='2'?Container(
                    ...
                    widget.likeFlag=='3'?Container(
                      ...
                      child: GestureDetector(
                        ...
                        child:Image(image: AssetImage('images/home/home_chat.png',),width:66 ,height: 66,),
                      ),
                    ):Container(),
  ...
  buganxingqu()async{
    ...
    Map<String, dynamic> map = {};
    map['id'] = widget.recordId;
    map['status'] = '1';
    print('map1111'+map.toString());

    NetWorkService service = await NetWorkService().init();
    service.put(Apis.updateMemberSeeme, data: map, successCallback: (data) async {
      BotToast.closeAllLoading();
      Navigator.pop(context);
