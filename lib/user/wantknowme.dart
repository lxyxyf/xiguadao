...
class Wantknowme extends StatefulWidget {
  final String userId;
  final String islikeeachother;
  final String seeMeFlag;
  final String recordId;
  const Wantknowme({super.key, required this.userId,required this.islikeeachother,required this.recordId,required this.seeMeFlag});
...
class _SecondPageState extends State<Wantknowme> {
      ...
      child:Stack(
        children: [
          ...
          lickclick==0?Positioned(
            ...
            child: Column(
              children: [
                widget.islikeeachother!='1'&&widget.seeMeFlag!='1'?Container(
