...
class XingzuoHomePage extends StatefulWidget {
  const XingzuoHomePage({super.key});
...
class MinePageState extends State<XingzuoHomePage> {
                ...
                child:  Container(
                    ...
                    child: Stack(
                        children: [
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      GestureDetector(
                                        ...
                                        child:Text(birthYear==''?'出生年份':birthYear,
                                      ...
                                      GestureDetector(
                                        ...
                                        child: Text(birthDay==''?'阳历出生日':birthDay,
                                            style: TextStyle(color: Color(0xff6A6AD7),fontSize: 15,fontWeight: FontWeight.w500)),
                                      ),
                                      SizedBox(width: 29.5,),
                                      GestureDetector(
                                        ...
                                        child:Text(birthTime==''?'出生时辰':birthTime,style:
                          ...
                          hadsubmit==false?Positioned(
                             left: 0,right: 0,
                              top: MediaQuery.of(context).padding.top+155+70+140+50,
                              ...
                              child:Container(
                                ...
                                height: 338.5,
                                alignment: Alignment.center,
                                child: Image(image: AssetImage('images/xingzuo/centercard.png',),fit: BoxFit.cover,
                                ),
                              )
                          ):Positioned(
                              right: 0,
                          ...
                          hadsubmit==false?Positioned(
                              left: (screenSize.width-172)/2,
                              // right: 0,
                              width: 172,
                              height: 51.5,
                              top: MediaQuery.of(context).padding.top+155+70+140+5+310,
                              child: Container(
                              // width: 172,
                              // height: 51.5,
                                  alignment: Alignment.center,
                                  // margin: EdgeInsets.only(left: 39.5,right: 39),
                                  decoration: BoxDecoration(
                                      image: DecorationImage(image: AssetImage('images/xingzuo/ceshi.png',),fit: BoxFit.cover)
                                  ),
                                  child:
                                  GestureDetector(
                                    onTap: (){
                                      ...
                                      //       return  XingzuoTijiaoLuyin();
                                      //     }));
                                    },
                                    child: Text('点击测试',style: TextStyle(color: Color(0xff16163A),fontSize: 18.58,fontWeight: FontWeight.w900),),
                                  )
                              )):Container(),
                        ]
                    ))
  ...
  Future<void> _showAddressPickerLive() async {
    ...
    if (result != null) {
      setState(() {
        livePlaceShow = '${result.provinceName},${result.cityName},${result.areaName}';
