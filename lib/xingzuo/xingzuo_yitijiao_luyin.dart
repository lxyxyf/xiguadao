...
class MinePageState extends State<XingzuoYitijiaoLuyin> {
  ...
  getTaskInfo()async{
    ...
    service.get(Apis.getDivinerConstellationTest, queryParameters: queryParameters, successCallback: (data) async {
      EasyLoading.dismiss();
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: [
                          ...
                          Positioned(
                              right: 0,
                              left: 0,top: MediaQuery.of(context).padding.top+155+70+40+111+105+0,
